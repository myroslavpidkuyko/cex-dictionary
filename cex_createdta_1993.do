...
infix ///
	...
	intno	8 - 8 ///
	HH_CU_Q	2249	-	2250	///		2
str	HH_CU_Q_	2251	-	2251	///	CHAR	1
	HHID	2252	-	2254	///		3
str	HHID_	2255	-	2255	///	CHAR	1
...
str	CHILDAGE	2302	-	2302	///	CHAR	1
str	CHIL_AGE	2303	-	2304	///	CHAR	2
...
str	POV_CY	2256	-	2256	///	CHAR	1
str	POV_CY_	2257	-	2257	///	CHAR	1
str	POV_PY	2258	-	2258	///	CHAR	1
str	POV_PY_	2259	-	2259	///	CHAR	1
	AGE_REF	11	-	13	///		3
...
str	INCC_NTX	584	-	584	///	CHAR	1
	CHDOTHX	2308	-	2315	///		8
str	CHDOTHX_	2316	-	2316	///	CHAR	1
	ALIOTHX	2317	-	2324	///		8
str	ALIOTHX_	2325	-	2325	///		1
	CHDLMPX	2326	-	2333	///	CHAR	8
str	CHDLMPX_	2334	-	2334	///		1
	OTHRINCX	758	-	765	///		8
...
str	HEATFUEL	2272	-	2273	///	CHAR	2
str	HEAT_UEL	2274	-	2274	///	CHAR	1
str	WATERHT	2287	-	2288	///	CHAR	2
str	WATERHT_	2289	-	2289	///	CHAR	1
...
str	SWIMPOOL	2278	-	2279	///	CHAR	2
str	SWIM_OOL	2280	-	2280	///	CHAR	1
str	TENNISCT	2281	-	2282	///	CHAR	2
str	TENN_SCT	2283	-	2283	///	CHAR	1
str	BARN	2260	-	2261	///	CHAR	2
str	BARN_	2262	-	2262	///	CHAR	1
str	GREENHSE	2266	-	2267	///	CHAR	2
str	GREE_HSE	2268	-	2268	///	CHAR	1
str	GUESTHSE	2269	-	2270	///	CHAR	2
str	GUES_HSE	2271	-	2271	///	CHAR	1
str	ENCPORCH	2263	-	2264	///	CHAR	2
str	ENCP_RCH	2265	-	2265	///	CHAR	1
str	TERRACE	2284	-	2285	///	CHAR	2
str	TERRACE_	2286	-	2286	///	CHAR	1
str	PATIO	2275	-	2276	///	CHAR	2
str	PATIO_	2277	-	2277	///	CHAR	1
str	APTMENT	2290	-	2291	///	CHAR	2
str	APTMENT_	2291	-	2291	///	CHAR	1
str	OFSTPARK	2293	-	2294	///	CHAR	2
str	OFST_ARK	2295	-	2295	///	CHAR	1
str	WINDOWAC	2296	-	2297	///	CHAR	2
str	WIND_WAC	2298	-	2298	///	CHAR	1
str	CNTRALAC	2299	-	2300	///	CHAR	2
str	CNTR_LAC	2301	-	2301	///	CHAR	1
	RENTEQVX	833	-	838	///		6
